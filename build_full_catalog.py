...
catalog_data = [
  # --- CHEST (NGỰC) ---
  {
    ...
    "primaryMuscles": [{"muscle": "chest", "ratio": 0.7}],
    "secondaryMuscles": [{"muscle": "triceps", "ratio": 0.2}, {"muscle": "shoulders", "ratio": 0.1}],
    "muscleTarget": {
      "primaryHead": "nguc_giua",
      "primaryHeadNameVi": "Ngực Giữa & Toàn Phần",
      "primaryHeadNameEn": "Mid & Lower Pectoralis",
      "secondaryHeads": ["Tay sau (Triceps)", "Vai trước (Anterior Delt)"],
  ...
  },
  {
    ...
    "equipment": "barbell",
    "movementPattern": "horizontal_push",
    "primaryMuscles": [{"muscle": "chest", "ratio": 0.65}],
    "secondaryMuscles": [{"muscle": "shoulders", "ratio": 0.2}, {"muscle": "triceps", "ratio": 0.15}],
    "muscleTarget": {
      "primaryHead": "nguc_tren",
      "primaryHeadNameVi": "Ngực Trên (Clavicular Head)",
      "primaryHeadNameEn": "Upper Pectoralis",
      "secondaryHeads": ["Vai trước", "Tay sau"],
  ...
  },
  {
    ...
    "muscleTarget": {
      ...
      "secondaryHeads": ["Tay sau", "Vai trước"],
  ...
  },
  {
    ...
    "equipment": "dumbbell",
    "movementPattern": "horizontal_push",
    "primaryMuscles": [{"muscle": "chest", "ratio": 0.75}],
    "secondaryMuscles": [{"muscle": "triceps", "ratio": 0.25}],
    "muscleTarget": {
      "primaryHead": "nguc_duoi",
      "primaryHeadNameVi": "Ngực Dưới (Abdominal Head)",
      "primaryHeadNameEn": "Lower Pectoralis",
      "secondaryHeads": ["Tay sau"],
  ...
  },
  {
    ...
    "equipment": "cable",
    "movementPattern": "horizontal_push",
    "primaryMuscles": [{"muscle": "chest", "ratio": 0.85}],
  ...
  },
  {
    ...
    "equipment": "cable",
    "movementPattern": "horizontal_push",
    "primaryMuscles": [{"muscle": "chest", "ratio": 0.8}],
    "secondaryMuscles": [{"muscle": "shoulders", "ratio": 0.2}],
    "muscleTarget": {
      "primaryHead": "nguc_tren",
  ...
  },
  {
    ...
    "equipment": "machine",
    "movementPattern": "horizontal_push",
    "primaryMuscles": [{"muscle": "chest", "ratio": 0.9}],
    "secondaryMuscles": [{"muscle": "shoulders", "ratio": 0.1}],
    "muscleTarget": {
      "primaryHead": "nguc_giua",
  ...
  },
  {
    ...
    "movementPattern": "horizontal_push",
    "primaryMuscles": [{"muscle": "chest", "ratio": 0.7}],
    "secondaryMuscles": [{"muscle": "shoulders", "ratio": 0.2}, {"muscle": "triceps", "ratio": 0.1}],
    "muscleTarget": {
      "primaryHead": "nguc_tren",
    ...
    "images": [
      "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Incline_Chest_Press/0.jpg",
      "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Incline_Chest_Press/1.jpg"
    ],
  ...
  },
  {
    ...
    "primaryMuscles": [{"muscle": "chest", "ratio": 0.65}],
    "secondaryMuscles": [{"muscle": "triceps", "ratio": 0.25}, {"muscle": "shoulders", "ratio": 0.1}],
    "muscleTarget": {
      "primaryHead": "nguc_duoi",
      "primaryHeadNameVi": "Ngực Dưới & Cắt Nét Viền Ngực",
      "primaryHeadNameEn": "Lower Pectoralis & Dips",
      "secondaryHeads": ["Tay sau (Triceps)", "Vai trước"],
  ...
  },
  {
    ...
    "equipment": "bodyweight",
    "movementPattern": "horizontal_push",
    "primaryMuscles": [{"muscle": "chest", "ratio": 0.6}],
    "secondaryMuscles": [{"muscle": "triceps", "ratio": 0.25}, {"muscle": "abs", "ratio": 0.15}],
    "muscleTarget": {
      "primaryHead": "nguc_giua",
      "primaryHeadNameVi": "Ngực Giữa & Sức Bền Lõi",
      "primaryHeadNameEn": "Mid Pectoralis & Core",
      "secondaryHeads": ["Tay sau", "Cơ bụng lõi"],
  ...
  # --- LATS & BACK (LƯNG & XÔ) ---
  {
    ...
    "primaryMuscles": [{"muscle": "lower_back", "ratio": 0.35}, {"muscle": "hamstrings", "ratio": 0.35}],
    "secondaryMuscles": [{"muscle": "glutes", "ratio": 0.15}, {"muscle": "lats", "ratio": 0.15}],
    "muscleTarget": {
      ...
      "secondaryHeads": ["Đùi sau", "Mông lớn", "Lưng xô"],
  ...
  },
  {
    ...
    "primaryMuscles": [{"muscle": "upper_back", "ratio": 0.5}, {"muscle": "lats", "ratio": 0.3}],
    "secondaryMuscles": [{"muscle": "biceps", "ratio": 0.2}],
    "muscleTarget": {
      ...
      "secondaryHeads": ["Tay trước", "Lưng xô"],
  ...
  },
  {
    ...
    "equipment": "dumbbell",
    "movementPattern": "horizontal_pull",
    "primaryMuscles": [{"muscle": "lats", "ratio": 0.6}],
    "secondaryMuscles": [{"muscle": "upper_back", "ratio": 0.25}, {"muscle": "biceps", "ratio": 0.15}],
    "muscleTarget": {
      "primaryHead": "lung_xo",
      "primaryHeadNameVi": "Cơ Xô Dày Từng Bên (Latissimus Dorsi)",
      "primaryHeadNameEn": "Latissimus Dorsi",
      "secondaryHeads": ["Lưng trên", "Tay trước"],
  ...
  },
  {
    ...
    "primaryMuscles": [{"muscle": "lats", "ratio": 0.7}],
    "secondaryMuscles": [{"muscle": "biceps", "ratio": 0.2}, {"muscle": "upper_back", "ratio": 0.1}],
    "muscleTarget": {
      "primaryHead": "lung_xo",
      "primaryHeadNameVi": "Độ Rộng Cơ Xô (Lat Width - Cánh Bướm)",
      "primaryHeadNameEn": "Latissimus Dorsi (Outer Sweep)",
      "secondaryHeads": ["Tay trước", "Lưng trên"],
  ...
  },
  {
    ...
    "equipment": "cable",
    "movementPattern": "vertical_pull",
    "primaryMuscles": [{"muscle": "lats", "ratio": 0.65}],
    "secondaryMuscles": [{"muscle": "biceps", "ratio": 0.25}, {"muscle": "upper_back", "ratio": 0.1}],
    "muscleTarget": {
      "primaryHead": "lung_xo",
      "primaryHeadNameVi": "Xô Dưới & Tay Trước (Lower Lats)",
      "primaryHeadNameEn": "Lower Latissimus Dorsi",
      "secondaryHeads": ["Tay trước", "Lưng giữa"],
  ...
  },
  {
    ...
    "equipment": "cable",
    "movementPattern": "horizontal_pull",
    "primaryMuscles": [{"muscle": "upper_back", "ratio": 0.5}],
    "secondaryMuscles": [{"muscle": "lats", "ratio": 0.3}, {"muscle": "biceps", "ratio": 0.2}],
    "muscleTarget": {
      "primaryHead": "lung_tren",
      "primaryHeadNameVi": "Độ Dày Lưng Giữa & Xô Ngang",
      "primaryHeadNameEn": "Mid Back Rhomboids & Lats",
      "secondaryHeads": ["Lưng xô", "Tay trước"],
  ...
  },
  {
    ...
    "equipment": "cable",
    "movementPattern": "vertical_pull",
    "primaryMuscles": [{"muscle": "lats", "ratio": 0.85}],
    "secondaryMuscles": [{"muscle": "upper_back", "ratio": 0.15}],
    "muscleTarget": {
      "primaryHead": "lung_xo",
      "primaryHeadNameVi": "Cô Lập Xô Không Ăn Tay Trước",
      "primaryHeadNameEn": "Lat Isolation Sweeps",
      "secondaryHeads": ["Cơ ngực dưới", "Cơ liên sườn"],
  ...
  },
  {
    ...
    "equipment": "machine",
    "movementPattern": "horizontal_pull",
    "primaryMuscles": [{"muscle": "upper_back", "ratio": 0.6}],
    "secondaryMuscles": [{"muscle": "lats", "ratio": 0.25}, {"muscle": "biceps", "ratio": 0.15}],
    "muscleTarget": {
      "primaryHead": "lung_tren",
  ...
  },
  {
    ...
    "equipment": "bodyweight",
    "movementPattern": "vertical_pull",
    "primaryMuscles": [{"muscle": "lats", "ratio": 0.55}],
    "secondaryMuscles": [{"muscle": "biceps", "ratio": 0.35}, {"muscle": "upper_back", "ratio": 0.1}],
    "muscleTarget": {
      "primaryHead": "lung_xo",
  ...
  },
  {
    ...
    "equipment": "bodyweight",
    "movementPattern": "hip_hinge",
    "primaryMuscles": [{"muscle": "lower_back", "ratio": 0.6}],
    "secondaryMuscles": [{"muscle": "glutes", "ratio": 0.25}, {"muscle": "hamstrings", "ratio": 0.15}],
    "muscleTarget": {
      "primaryHead": "lung_duoi",
      "primaryHeadNameVi": "Dựng Sống Lưng Dưới (Erector Spinae)",
      "primaryHeadNameEn": "Erector Spinae Lower Back",
      "secondaryHeads": ["Mông", "Đùi sau"],
  ...
  # --- SHOULDERS (VAI) ---
  {
    ...
    "equipment": "barbell",
    "movementPattern": "vertical_push",
    "primaryMuscles": [{"muscle": "shoulders", "ratio": 0.7}],
    "secondaryMuscles": [{"muscle": "triceps", "ratio": 0.2}, {"muscle": "upper_back", "ratio": 0.1}],
    "muscleTarget": {
      "primaryHead": "vai_truoc",
      "primaryHeadNameVi": "Vai Trước & Sức Mạnh Thân Trên",
      "primaryHeadNameEn": "Anterior Deltoid & Core",
      "secondaryHeads": ["Tay sau", "Cầu vai"],
  ...
  },
  {
    ...
    "movementPattern": "vertical_push",
    "primaryMuscles": [{"muscle": "shoulders", "ratio": 0.7}],
    "secondaryMuscles": [{"muscle": "triceps", "ratio": 0.2}, {"muscle": "traps", "ratio": 0.1}],
    "muscleTarget": {
      "primaryHead": "vai_truoc",
      "primaryHeadNameVi": "Vai Trước & Bờ Vai Rộng",
      "primaryHeadNameEn": "Anterior & Lateral Deltoid",
      "secondaryHeads": ["Tay sau", "Vai giữa"],
  ...
  },
  {
    ...
    "equipment": "cable",
    "movementPattern": "horizontal_pull",
    "primaryMuscles": [{"muscle": "shoulders", "ratio": 0.5}, {"muscle": "upper_back", "ratio": 0.3}],
    "secondaryMuscles": [{"muscle": "traps", "ratio": 0.2}],
    "muscleTarget": {
      "primaryHead": "vai_sau",
      "primaryHeadNameVi": "Vai Sau & Cơ Xoay Khớp Vai (Posterior Delt)",
      "primaryHeadNameEn": "Rear Deltoid & Rotator Cuff",
      "secondaryHeads": ["Cầu vai", "Lưng trên"],
  ...
  },
  {
    ...
    "movementPattern": "isolation",
    "primaryMuscles": [{"muscle": "shoulders", "ratio": 0.75}],
    "secondaryMuscles": [{"muscle": "upper_back", "ratio": 0.25}],
    "muscleTarget": {
      "primaryHead": "vai_sau",
    ...
    "images": [
      "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Rear_Delt_Machine/0.jpg",
      "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Rear_Delt_Machine/1.jpg"
    ],
  ...
  },
  {
    ...
    "equipment": "barbell",
    "movementPattern": "isolation",
    "primaryMuscles": [{"muscle": "traps", "ratio": 0.85}],
    "secondaryMuscles": [{"muscle": "forearms", "ratio": 0.15}],
    "muscleTarget": {
      "primaryHead": "cau_vai",
      "primaryHeadNameVi": "Cầu Vai Cao & Dày (Upper Trapezius)",
      "primaryHeadNameEn": "Upper Traps Peak",
      "secondaryHeads": ["Cẳng tay"],
  ...
  # --- BICEPS (TAY TRƯỚC) ---
  {
    ...
    "equipment": "barbell",
    "movementPattern": "isolation",
    "primaryMuscles": [{"muscle": "biceps", "ratio": 0.85}],
    "secondaryMuscles": [{"muscle": "forearms", "ratio": 0.15}],
    "muscleTarget": {
  ...
  },
  {
    ...
    "equipment": "dumbbell",
    "movementPattern": "isolation",
    "primaryMuscles": [{"muscle": "biceps", "ratio": 0.9}],
    "secondaryMuscles": [{"muscle": "forearms", "ratio": 0.1}],
    "muscleTarget": {
      "primaryHead": "tay_truoc_dai",
  ...
  # --- TRICEPS (TAY SAU) ---
  {
    ...
    "equipment": "cable",
    "movementPattern": "isolation",
    "primaryMuscles": [{"muscle": "triceps", "ratio": 0.9}],
    "secondaryMuscles": [],
    "muscleTarget": {
  ...
  },
  {
    ...
    "equipment": "cable",
    "movementPattern": "isolation",
    "primaryMuscles": [{"muscle": "triceps", "ratio": 0.95}],
    "secondaryMuscles": [],
    "muscleTarget": {
      "primaryHead": "tay_sau_ngoai",
  ...
  },
  {
    ...
    "equipment": "barbell",
    "movementPattern": "horizontal_push",
    "primaryMuscles": [{"muscle": "triceps", "ratio": 0.65}],
    "secondaryMuscles": [{"muscle": "chest", "ratio": 0.25}, {"muscle": "shoulders", "ratio": 0.1}],
    "muscleTarget": {
      "primaryHead": "tay_sau_ngoai",
      "primaryHeadNameVi": "Đẩy Nặng Tăng Khối Lượng Tay Sau",
      "primaryHeadNameEn": "Triceps Compound Mass",
      "secondaryHeads": ["Ngực giữa"],
  ...
  # --- QUADRICEPS & LEGS (ĐÙI TRƯỚC & CHÂN) ---
  {
    "id": "barbell_squat",
    ...
    "primaryMuscles": [{"muscle": "quads", "ratio": 0.6}],
    "secondaryMuscles": [{"muscle": "glutes", "ratio": 0.25}, {"muscle": "lower_back", "ratio": 0.15}],
    "muscleTarget": {
      "primaryHead": "dui_truoc",
      "primaryHeadNameVi": "Đùi Trước & Toàn Bộ Thân Dưới (Quads & Core)",
      "primaryHeadNameEn": "Quadriceps Femoris & Core",
      "secondaryHeads": ["Mông lớn", "Lưng dưới", "Đùi sau"],
  ...
  },
  {
    ...
    "equipment": "barbell",
    "movementPattern": "squat",
    "primaryMuscles": [{"muscle": "quads", "ratio": 0.75}],
    "secondaryMuscles": [{"muscle": "abs", "ratio": 0.15}, {"muscle": "glutes", "ratio": 0.1}],
    "muscleTarget": {
      "primaryHead": "dui_truoc",
      "primaryHeadNameVi": "Đùi Trước Cô Lập & Lưng Thẳng Đứng",
      "primaryHeadNameEn": "Quadriceps Dominant Squat",
      "secondaryHeads": ["Cơ bụng lõi"],
  ...
  },
  {
    ...
    "equipment": "machine",
    "movementPattern": "squat",
    "primaryMuscles": [{"muscle": "quads", "ratio": 0.65}],
    "secondaryMuscles": [{"muscle": "glutes", "ratio": 0.25}, {"muscle": "hamstrings", "ratio": 0.1}],
    "muscleTarget": {
      "primaryHead": "dui_truoc",
      "primaryHeadNameVi": "Khối Cơ Đùi Trước Tải Nặng An Toàn Lưng",
      "primaryHeadNameEn": "Quadriceps Mass Builder",
      "secondaryHeads": ["Mông lớn"],
  ...
  },
  {
    ...
    "equipment": "machine",
    "movementPattern": "isolation",
    "primaryMuscles": [{"muscle": "quads", "ratio": 0.95}],
    "secondaryMuscles": [],
    "muscleTarget": {
      "primaryHead": "dui_truoc",
  ...
  },
  {
    ...
    "equipment": "dumbbell",
    "movementPattern": "squat",
    "primaryMuscles": [{"muscle": "quads", "ratio": 0.5}, {"muscle": "glutes", "ratio": 0.4}],
    "secondaryMuscles": [{"muscle": "hamstrings", "ratio": 0.1}],
    "muscleTarget": {
      "primaryHead": "dui_truoc",
      "primaryHeadNameVi": "Đùi Trước & Mông Đơn Lập (Khắc Phục Lệch Cơ)",
      "primaryHeadNameEn": "Unilateral Quads & Glute Max",
      "secondaryHeads": ["Mông lớn", "Đùi sau"],
  ...
  },
  {
    ...
    "movementPattern": "squat",
    "primaryMuscles": [{"muscle": "quads", "ratio": 0.65}],
    "secondaryMuscles": [{"muscle": "glutes", "ratio": 0.25}, {"muscle": "abs", "ratio": 0.1}],
    "muscleTarget": {
      "primaryHead": "dui_truoc",
      "primaryHeadNameVi": "Squat Ôm Tạ Trước Ngực",
      "primaryHeadNameEn": "Quads & Core Stability",
      "secondaryHeads": ["Mông", "Cơ bụng"],
  ...
  # --- HAMSTRINGS & GLUTES (ĐÙI SAU & MÔNG) ---
  {
    ...
    "equipment": "barbell",
    "movementPattern": "hip_hinge",
    "primaryMuscles": [{"muscle": "hamstrings", "ratio": 0.55}, {"muscle": "glutes", "ratio": 0.35}],
    "secondaryMuscles": [{"muscle": "lower_back", "ratio": 0.1}],
    "muscleTarget": {
      "primaryHead": "dui_sau",
      "primaryHeadNameVi": "Kéo Căng Cơ Đùi Sau & Nở Mông (Hamstring Stretch)",
      "primaryHeadNameEn": "Biceps Femoris & Gluteus Maximus",
      "secondaryHeads": ["Mông lớn", "Lưng dưới"],
  ...
  },
  {
    ...
    "equipment": "machine",
    "movementPattern": "isolation",
    "primaryMuscles": [{"muscle": "hamstrings", "ratio": 0.95}],
    "secondaryMuscles": [{"muscle": "calves", "ratio": 0.05}],
    "muscleTarget": {
      "primaryHead": "dui_sau",
  ...
  },
  {
    ...
    "equipment": "barbell",
    "movementPattern": "hip_hinge",
    "primaryMuscles": [{"muscle": "glutes", "ratio": 0.75}],
    "secondaryMuscles": [{"muscle": "hamstrings", "ratio": 0.25}],
    "muscleTarget": {
      "primaryHead": "co_mong",
      "primaryHeadNameVi": "Cơ Mông Lớn Cực Đại (Gluteus Maximus)",
      "primaryHeadNameEn": "Gluteus Maximus King",
      "secondaryHeads": ["Đùi sau"],
  ...
  },
  {
    ...
    "equipment": "cable",
    "movementPattern": "isolation",
    "primaryMuscles": [{"muscle": "glutes", "ratio": 0.9}],
    "secondaryMuscles": [{"muscle": "hamstrings", "ratio": 0.1}],
    "muscleTarget": {
      "primaryHead": "co_mong",
  ...
  # --- CALVES (BẮP CHÂN) ---
  {
    ...
    "equipment": "machine",
    "movementPattern": "isolation",
    "primaryMuscles": [{"muscle": "calves", "ratio": 0.95}],
    "secondaryMuscles": [],
    "muscleTarget": {
  ...
  # --- ABS & CORE (CƠ BỤNG & LÕI) ---
  {
    ...
    "equipment": "cable",
    "movementPattern": "isolation",
    "primaryMuscles": [{"muscle": "abs", "ratio": 0.85}],
    "secondaryMuscles": [{"muscle": "shoulders", "ratio": 0.15}],
    "muscleTarget": {
      ...
      "secondaryHeads": ["Cơ thẳng bụng", "Vai"],
  ...
  },
  {
    ...
    "equipment": "cable",
    "movementPattern": "isolation",
    "primaryMuscles": [{"muscle": "abs", "ratio": 0.95}],
    "secondaryMuscles": [],
    "muscleTarget": {
      "primaryHead": "co_bung",
  ...
  },
  {
    ...
    "equipment": "machine",
    "movementPattern": "cardio",
    "primaryMuscles": [{"muscle": "glutes", "ratio": 0.5}, {"muscle": "calves", "ratio": 0.5}],
    "secondaryMuscles": [],
    "muscleTarget": {
      "primaryHead": "co_mong",
...
header = '''import { MuscleGroup, MuscleInfo, ExerciseItem } from '../types';
...
with open('src/data/exerciseCatalog.ts', 'w', encoding='utf-8') as f:
    f.write(content)

print(f"Generated {len(catalog_data)} exercises in src/data/exerciseCatalog.ts")
